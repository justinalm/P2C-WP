...
-->
  ...
  <meta name="description" content="The website for Power To Change Students conference P2C+" />
...
<body>
    ...
    <header><!-- Begin the Header Container -->
       ...
       <div id="nav">
         ...
         <ul class="info">
           <a href="/plus/home"><li>Home <span class="icon" id="smallmenuhome">&iuml;</span></li></a>
           <a href="/plus/speakersbands/"><li>speakers + bands <span class="icon" id="smallmenu">O</span></li></a>
           <a href="/plus/schedule/"><li>schedule <span class="icon" id="smallmenu">P</span></li></a>
           <a href="/plus/workshops/"><li>workshops <span class="icon" id="smallmenu">@</span></li></a>
           <a href="/plus/outreach/"><li>outreach <span class="icon" id="smallmenu">9</span></li></a>
           <a href="/plus/opportunities/"><li>opportunities <span class="icon" id="smallmenu">$</span></li></a>
         </ul>
      </header>
